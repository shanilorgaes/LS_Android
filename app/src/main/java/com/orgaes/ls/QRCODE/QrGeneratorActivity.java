...
import com.orgaes.ls.Activity_Menu_Page;
...
public class QrGeneratorActivity extends AppCompatActivity {
    ...
    String Type,ID;
    String userID,ClientID="0",ClaimID,LrID,Date;
...
//                    Expired.setVisibility(View.GONE);
    ...
    private void popupLuckData(List<LuckDetails_Model> todaysLuck_homes, String type) {
        ...
        dialog = new Dialog(getApplicationContext(), android.R.style.Theme_Dialog);
    ...
    private void Redeem() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        System.out.println("LS REDEEM 111 "+auth_token+"    "+ID+"    "+LrID+"    "+Type);
            call3 = apiInterface.Api_Redeeem(auth_token,ID,LrID,Type );
