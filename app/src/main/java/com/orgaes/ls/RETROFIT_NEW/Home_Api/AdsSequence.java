...
public class AdsSequence {
    ...
    @Expose
    private List<LTimer_> lTimer = null;
     ...
     * @param adsLuckStatus
     */
    public AdsSequence(String adsId, String adsType, String adsFile, String adsViewTime, String adsVoice, String adsVoiceFile, String adsLinkImage, String adsCoinCollectionTime, String adsCoinCollectionNo, String adsLuckStatus, String adsDefaultStatus, List<LTimer_> lTimer) {
        super();
        this.adsId = adsId;
    ...
    public List<LTimer_> getLTimer() {
        return lTimer;
    }

    public void setLTimer(List<LTimer_> lTimer) {
        this.lTimer = lTimer;
    }
