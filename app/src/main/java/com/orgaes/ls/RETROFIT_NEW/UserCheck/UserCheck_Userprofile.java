...
public class UserCheck_Userprofile {
     ...
     * @param coin
     */
    public UserCheck_Userprofile(String id, String name, String photoUrl, String mobile, String email, String selfInfo, String photoApprovalStatus, String profession, String registerDate, String gender, String groupCode, String phone, String coin, String activeLuck, String totalLuck, String voucher, String shareLuck, String wallet, String shareCoin, String friends, String exchanges, String chat, String photo, String isActive) {
        super();
        this.id = id;
        this.name = name;
