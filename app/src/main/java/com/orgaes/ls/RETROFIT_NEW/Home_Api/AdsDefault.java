...
public class AdsDefault {
    ...
    @Expose
    private List<LTimer__> lTimer = null;
     ...
     * @param adsLuckStatus
     */
    public AdsDefault(String adsId, String adsType, String adsFile, String adsViewTime, String adsVoice, String adsVoiceFile, String adsLinkImage, String adsCoinCollectionTime, String adsCoinCollectionNo, String adsLuckStatus, String adsDefaultStatus, List<LTimer__> lTimer) {
        super();
        this.adsId = adsId;
    ...
    public List<LTimer__> getLTimer() {
        return lTimer;
    }

    public void setLTimer(List<LTimer__> lTimer) {
        this.lTimer = lTimer;
    }
