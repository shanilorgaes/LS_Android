...
public class LuckRadar_Details {
     ...
     */
    public LuckRadar_Details(String id, String name, String image, String description, String unitCount, String unit, String unitCoinCost, String collectionCenter, String endDate, String clientUserFname, String clientUserLname) {
        super();
        this.id = id;
        this.name = name;
        this.image = image;
