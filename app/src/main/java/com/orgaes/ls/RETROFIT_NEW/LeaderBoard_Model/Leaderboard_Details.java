...
public class Leaderboard_Details {
     ...
     * @param userId
     */
    public Leaderboard_Details(String userId, String coins, String name, String photoUrl, String photoApprovalStatus, String photoLockStatus, String rank, String totalLucks) {
        super();
        this.userId = userId;
        this.coins = coins;
        this.name = name;
