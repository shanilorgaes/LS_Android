...
/*
 * Purpose – ImagePickerActivity is an image cropping activity for profile pic change
 * @author SHANIL
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            Toast toast = Toast.makeText(getApplicationContext(),"No Image", Toast.LENGTH_LONG);
